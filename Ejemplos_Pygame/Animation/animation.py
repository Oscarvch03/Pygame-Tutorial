...
# En el programa animation.py vamos a crear con una serie de imagenes...
# ... una animación de un personaje en Pygame."
...
# Vamos a crear dos listas, una que tenga los movimientos hacia la...
# ...izquierda y la otra hacia la derecha, los elementos de esta...
# ...lista son Sprites.

# Cuando se mueva a la Derecha
Derecha = [pygame.image.load('R1.png'), pygame.image.load('R2.png'),
...
Izquierda = [pygame.image.load('L1.png'), pygame.image.load('L2.png'),
...
# Inicializamos un objeto de tipo Clock
...
def dibujar():
	""" Esta es la funcion que va a "dibujar" lo que se va a mostrar
	en el Frame"""
	# Volvemos la variable walkCount a una variable global
	global walkCount

	# Fondo de la animacion (variable_de_la_imagen_del_fondo...
	# ... (posicion_x, posicion_y))
	ventana.blit(Fondo, (0,0))

	# Vamos a hacer que cada "posicion" del proceso de desplazamiento...
	# ... dure 3 loops, al ser 9 posiciones son 27 el numero loops que...
	# ... hara para generar la animacion de un paso
	if walkCount + 1 >= 27:
		walkCount = 0

	# Si se desplaza a la izquierda va a reproducir las imagenes de...
	# ... nuestra lista walkLeft
	if Izq:
		ventana.blit(Izquierda[walkCount//3], (x, y))
		walkCount += 1

	# Si se desplaza a la derecha va a reproducir las imagenes de...
	# ... nuestra lista walkRight
	elif Der:
...
while estado:
	...
	# Al accionar las teclas del teclado el personaje se desplazara...
	# ... a la izquierda
	...
	# En este condicional buscamos que en el momento en  el personaje...
	# ... este saltando y no se desplaze lateralmente se vera la...
	# ... imagen de frente
	if not(isJump):
